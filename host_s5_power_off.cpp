...
{
    struct HostS5PowerOffRequest request;
    ...
    std::memcpy(&request, &reqBuf[0], sizeof(struct HostS5PowerOffRequest));
    try
    {
        handler->hostS5PowerOffDelay(request.delay);
    }
