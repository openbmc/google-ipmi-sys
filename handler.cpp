...
uint32_t isBmcInBareMetalMode()
{
#ifdef BARE_METAL
    return static_cast<uint32_t>(BmcMode::BM_MODE);
#else
    return static_cast<uint32_t>(BmcMode::NON_BM_MODE);
#endif
}

uint32_t Handler::getBmcMode()
{
