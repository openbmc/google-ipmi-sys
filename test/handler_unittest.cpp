...
TEST(HandlerTest, PcieBifurcation)
{
    ...
    */
    ...
    std::vector<I2CTree> i2cTree = {
        {"i2c-10", "10-0077", {"i2c-30", "i2c-40", "i2c-50", "i2c-11"}},
        {"i2c-30", "30-0070", {"i2c-31", "i2c-32"}},
        {"i2c-40", "40-0070", {"i2c-41", "i2c-42"}},
        {"i2c-50", "50-0070", {"i2c-51", "i2c-52"}},
        {"i2c-51", "51-0070", {"i2c-53", "i2c-54", "i2c-55"}},
        {"i2c-20", "20-0077", {"i2c-60", "i2c-70", "i2c-21", "i2c-22"}},
        {"i2c-70", "70-0070", {"i2c-71", "i2c-72"}},
        {"i2c-71", "71-0070", {"i2c-73", "i2c-74"}},
        // Empty paths
        {"i2c-11", std::nullopt, {}},
        {"i2c-21", std::nullopt, {}},
        {"i2c-22", std::nullopt, {}},
    ...
    for (const auto& bi : bifurcation)
    {
        std::cout << std::to_string(bi) << std::endl;
    }
    ASSERT_EQ(bifurcation.size(), expectedOutput.size());
    for (size_t i = 0; i < bifurcation.size(); ++i)
    {
