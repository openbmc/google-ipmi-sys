...
TEST(HandlerTest, PcieBifurcationDynamic)
{
    ...
    */
    ...
    std::string contents = R"(
        {
            "add_in_card": [
                ...
                {"instance": 99, "name": "/PE2"},
                {"instance": 100, "name": "/PE3"}
            ]
        }
    )";
    std::ofstream outputJson(testFilename);
    ...
    auto bifurcation = h.pcieBifurcation(1, true);
    ...
    bifurcation = h.pcieBifurcation(0, true);
